...
impl ChartModulesService {
    ...
    pub fn new() -> Result<Self> {
        ...
        let chart_content = Self::prepare_chart_modules(&priority_order)?;
        info!(
            "✅ Layer 1: Chart modules đã sẵn sàng. ({} bytes)",
            chart_content.len()
        );
    ...
    fn prepare_chart_modules(priority_order: &[String]) -> Result<String> {
        ...
        debug!(
            "📦 Layer 1: Loading chart modules in order: {:?}",
            sorted_files
        );
