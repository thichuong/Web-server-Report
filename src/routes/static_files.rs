...
pub fn configure_static_routes() -> Router<Arc<ServiceIslands>> {
    Router::new()
        ...
        .nest_service(
            "/crypto_dashboard/shared",
            ServeDir::new("dashboards/crypto_dashboard/shared"),
        )
        .nest_service(
            "/crypto_dashboard/routes",
            ServeDir::new("dashboards/crypto_dashboard/routes"),
        )
        .nest_service(
            "/crypto_dashboard/assets",
            ServeDir::new("dashboards/crypto_dashboard/assets"),
        )
        .nest_service(
            "/crypto_dashboard/pages",
            ServeDir::new("dashboards/crypto_dashboard/pages"),
        )
        // Stock Dashboard static files - minimal (only shared templates exist)
        .nest_service(
            "/stock_dashboard/shared",
            ServeDir::new("dashboards/stock_dashboard/shared"),
        )
        // Shared components and assets
