...
impl ReportCreator {
    ...
    pub fn get_chart_modules_content(&self, state: &Arc<AppState>) -> Arc<String> {
        debug!("ReportCreator: Requesting chart modules from AppState");
        Arc::clone(&state.chart_modules_content)
    }
