function get_translations_data()
{
    ...
    'ai-generated-disclaimer': { vi: 'Báo cáo được tạo tự động bởi trí tuệ nhân tạo (AI) dựa trên dữ liệu thị trường thời gian thực. Không đảm bảo tính chính xác tuyệt đối và có thể chứa lỗi.', en: 'Reports are automatically generated by artificial intelligence (AI) based on real-time market data. Absolute accuracy is not guaranteed and may contain errors.' },
